...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">铜仁幼专</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
			<span class="logo navbar-slogan f-l mr-10 hidden-xs">v10</span> 
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
				    <li><a data-href="#" data-title="资讯管理" href="javascript:void(0)">资讯分类管理</a></li>
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="#" data-title="视频管理" href="javascript:void(0)">视频分类管理</a></li>
		
					<li><a data-href="picture-list.html" data-title="视频管理" href="javascript:void(0)">图片管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
		...
		<dl id="menu-admin">
			...
			<dl id="menu-admin">
			<dt><i class="Hui-iconfont">&#xe62d;</i> 数据采集管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="admin-role.html" data-title="角色管理" href="javascript:void(0)">采集表设计管理</a></li>
					<li><a data-href="admin-list.html" data-title="管理员列表" href="javascript:void(0)">采集表信息管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-tongji">
